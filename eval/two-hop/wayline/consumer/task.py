"""
E0 two-hop microbenchmark — DSF consumer.

Reads:
    DSF_E0_BYTES   : expected payload size in bytes (for sanity check)

Emits one tagged JSON line:

    DSF_E0_TIMESTAMPS {"role":"consumer","pod":"...","node":"...",
...
EXPECTED_BYTES = int(os.environ.get("DSF_E0_BYTES", "1048576"))
